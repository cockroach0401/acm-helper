...
export const translations = {
    en: {
        ...
        status_all: 'All',
        solution_status_none: 'Not Generated',
        solution_status_queued: 'Queued',
        solution_status_running: 'Generating',
        solution_status_done: 'Done',
        solution_status_failed: 'Failed',
        ...
        heatmap_less: 'Less',
        heatmap_more: 'More',
        heatmap_total: '{count} submissions in the past year',
        heatmap_tooltip: '{count} submissions on {date}',
        heatmap_tooltip_none: 'No submissions on {date}',
        chart_weekly: 'Weekly Progress',
        chart_tags_solved: 'Tags Solved',
        ...
        msg_no_tags_data: 'No tag data',
        label_tags_total: 'Total',
        ...
        label_markdown_naming_mode: 'Markdown Naming',
        markdown_naming_title: 'By Title',
        markdown_naming_source_id: 'By Source + ID',
        hint_markdown_naming_mode: 'Choose how problem and solution markdown files are named. Changing this also migrates existing files.',
        ...
        msg_unsaved_problem_changes: 'You have unsaved problem edits. Leave and discard them?',
        msg_unsaved_settings_changes: 'You have unsaved settings changes. Leave and discard them?',
        ...
        msg_auto_tag_task_creating: 'Creating AI tag task...',
        msg_auto_tag_task_queued: 'AI tag task queued',
    ...
    zh: {
        ...
        status_unsolved: '未解决',
        status_all: '全部',
        solution_status_none: '未生成',
        solution_status_queued: '排队中',
        solution_status_running: '生成中',
        solution_status_done: '已生成',
        solution_status_failed: '失败',
        ...
        heatmap_less: '少',
        heatmap_more: '多',
        heatmap_total: '过去一年共 {count} 次提交',
        heatmap_tooltip: '{date} 做了 {count} 道题',
        heatmap_tooltip_none: '{date} 无记录',
        chart_weekly: '每周进度',
        chart_tags_solved: '标签题量分布',
        ...
        hint_obsidian_mode: '启用后，题目和题解 Markdown 都会写入 Obsidian 中的属性',
        label_markdown_naming_mode: 'Markdown 命名方式',
        markdown_naming_title: '按题目标题',
        markdown_naming_source_id: '按来源+题号',
        hint_markdown_naming_mode: '选择题目与题解 Markdown 的命名方式。切换时会同时迁移已有文件。',
        ...
        msg_unsaved_problem_changes: '有未保存的题目编辑内容，是否离开并放弃？',
        msg_unsaved_settings_changes: '有未保存的设置更改，是否离开并放弃？',
        ...
        msg_auto_tag_task_creating: '正在创建 AI 标签任务...',
        msg_auto_tag_task_queued: 'AI 标签任务已加入队列',
        msg_confirm_auto_tag_without_solution: '当前没有题解 Markdown，是否仍继续 AI 标签分类？(有题解时会更精准)',
        msg_select_week: '请选择周。',
        task_type_weekly_report: '周报任务',
        task_type_phased_report: '阶段性报告任务',
        task_type_ai_tag: 'AI 标签任务',
